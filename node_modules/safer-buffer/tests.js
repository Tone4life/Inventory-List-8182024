...
test('Methods return Buffers', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.ok(buffer.Buffer.isBuffer(impl.Buffer.from('string', 'utf8')))
...
test('Constructor is buffer.Buffer', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.equal(impl.Buffer.from('string', 'utf8').constructor, buffer.Buffer)
...
test('Invalid calls throw', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.throws(function () { impl.Buffer.from(10, 'utf8') })
...
test('Buffers have appropriate lengths', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.equal(impl.Buffer.from('string', 'utf8').length, 6)
...
test('safer.Buffer.from returns results same as Buffer constructor', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.deepEqual(impl.Buffer.from('string', 'utf8'), new buffer.Buffer('string', 'utf-8'))
...
test('safer.Buffer.from returns consistent results', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.deepEqual(impl.Buffer.from('string', 'utf8'), impl.Buffer.from('string'))
